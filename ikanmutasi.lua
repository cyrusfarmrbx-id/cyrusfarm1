...
local BLACKLIST_IDS = {
    11175300507, 11175282711 
}

local AutoSetConfig = {
    [158] = { Name = "King Crab", Price = 6 },
    [187] = { Name = "Queen Crab", Price = 6 },
    [82]  = { Name = "Blob Shark", Price = 6 },
    [83]  = { Name = "Ghost Shark", Price = 6 },
    [359] = { Name = "Gladiator Shark", Price = 6 },
    [339] = { Name = "Skeleton Narwhal", Price = 6 },
    [269] = { Name = "Elshark Gran Maja", Price = 6 },
    [145] = { Name = "Worm Fish", Price = 5 },
    [661] = { Name = "Elpirate Gran Maja", Price = 16 },
    [226] = { Name = "Megalodon", Price = 455 },
